...
public class JdbcUserDao implements UserDao {
    ...
    public void createUserInfo(UserInfo user){
        String sql="INSERT INTO user_info (user_id, user_first, user_last, address, city, state, zip_code) "+
                "VALUES ((SELECT user_id from users where username= ?), ?, ?, ?, ?, ?, ?)";
        jdbcTemplate.update(sql, user.getUserName(), user.getUserFirstName(), user.getUserLastName(), user.getAddress(), user.getCity(),
